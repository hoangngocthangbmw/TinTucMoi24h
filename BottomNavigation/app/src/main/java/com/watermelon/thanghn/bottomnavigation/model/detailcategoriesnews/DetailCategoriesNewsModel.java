package com.watermelon.thanghn.bottomnavigation.model.detailcategoriesnews;
...
import com.watermelon.thanghn.bottomnavigation.screen.detailcategoriesnews.IDetailCategoriesNewsModel;
...
public class DetailCategoriesNewsModel {
    private IDetailCategoriesNewsModel callback;
    private DBNews dbNews;

    public DetailCategoriesNewsModel(IDetailCategoriesNewsModel callback) {
        this.callback = callback;
    }

    public void HandleGetHtmlByLink(String link) {
        ...
        StringRequest stringRequest = new StringRequest(Request.Method.GET, link, new Response.Listener<String>() {
            ...
            public void onResponse(String response) {
                ...
                if (title.size() > 0 || date.size() > 0 || description.size() > 0 || main.size() > 0) {
                    ...
                    callback.onHandleGetHtmlByLinkSuccess(detail);
                } else {
                    callback.onHandleGetHtmlByLinkFailed("Bài viết đang cập nhập");
                }
...
//                }
            ...
            public void onErrorResponse(VolleyError error) {
                callback.onHandleGetHtmlByLinkFailed("Vui lòng kiểm tra kết nối!");
            }
        });
